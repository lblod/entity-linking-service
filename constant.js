export const TASK_ENTITY_LINKING = "http://lblod.data.gift/id/jobs/concept/TaskOperation/entity-linking";
...
export const PUBLISHER_URI =
    process.env.PUBLISHER_URI || "http://data.lblod.info/services/entity-linking-service";
